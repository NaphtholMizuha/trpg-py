...
使用方式:
  python smoke/test_grep.py
  python smoke/test_grep.py --json
  python smoke/test_grep.py --query "goblin scimitar to_hit"
  python smoke/test_grep.py --term goblin --term scimitar --term to_hit
  python smoke/test_grep.py --state-file ./config/world_state.toml
"""
...
from trpg_py.agent.tools import create_grep_tool
