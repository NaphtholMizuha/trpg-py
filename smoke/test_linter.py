...
使用方式:
  python smoke/test_linter.py
  python smoke/test_linter.py --json
  python smoke/test_linter.py --document-file ./examples/goblin_scimitar_attack.json
"""
...
from trpg_py.agent.tools import create_lint_tool
