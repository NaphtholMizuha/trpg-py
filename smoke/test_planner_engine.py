...
使用方式:
  python smoke/test_planner_engine.py
  python smoke/test_planner_engine.py --json
  python smoke/test_planner_engine.py --instruction "哥布林用弯刀攻击 aldera"
  python smoke/test_planner_engine.py --roll 12 --roll 4
  python smoke/test_planner_engine.py --thread-id <thread> --resume-json '{"decisions":[{"type":"approve"}]}'
"""
